...
const FormSignup = ({ submitForm }) => {
  ...
  function onSubmitChange() {
    ...
    {
       setCaptcha("noch nicht bestätigt");
       document.getElementById("errormessage").innerHTML = captcha;
      ...
      <form action="" method="" className='form' onSubmit={submitHandler}>
        ...
        <div className="recaptcha" required>
          <Recaptcha
            ...
            verifyCallback= {(e) => setCaptcha("1")}
            
          />
        </div>
        <p className="errorvalidation" id="errormessage"></p>
      </form>
    </div>
  );
};
