    ...
    <>
      ...
      <div className="Main-Fragen-Heading">
        ...
        <div className="Main-Fragen-Img">
          <FaIcons.FaHiking className="Wandern-Img" onClick={() => history.push("/fragen = lele")} href="lele" />
          
          <FaIcons.FaSkiingNordic className="Ski-Img" />
          <FaIcons.FaMountain className="Klettern-Img" />
